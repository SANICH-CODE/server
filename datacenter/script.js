const store = new Vuex.Store({
  state: {
    // initial state
    servers: [
    { name: 'BN Data', status: true, adr: '192.168.0.24', type: 'database' },
    { name: 'Vass Group Server One', status: true, adr: '185.199.110.153' },
    { name: 'Vass Group FTP Server', status: true, adr: '192.168.0.24', type: 'database' },
    { name: 'vass-group.xyz', status: true, adr: '185.199.111.153' },
    { name: 'Backup server', status: true, adr: '185.199.111.153' },
    { name: 'Vass Global', status: false, adr: 'files not found' }] },
